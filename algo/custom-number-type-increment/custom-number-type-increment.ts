 ...
 */
const isDigit = (num: number): boolean => {
  return num >= 0 && num <= 9;
};
 ...
 */
const isDigitArray = (numArr: Array<number>): boolean => {
 ...
 *
 * */
const increment = (num: Array<number>): Array<number> => {
  if (num.length < 1) {
...
const main = () => {
  try {
    ...
    console.log(
      "Expected : [2, 0, 0, 0] | Result : " + increment([1, 9, 9, 9])
    );

    console.log(
      "Expected : [3, 0, 0, 0] | Result : " + increment([2, 9, 9, 9])
    );

    console.log(
      "Expected : [1, 9, 9, 9] | Result : " + increment([1, 9, 9, 8])
    );
